...
namespace Prateek.Runtime.PersonalLogger {
    ...
    public class PersonalLoggerManager
    {
        ...
        public class GUISetup
        {
            ...
            {
                //TODO BHU ---------------------
                var settings = new PersonalLogger.GUISettings(); //GlobalSettings.OcpBlackBoxDebugSettings;
        ...
        ///---------------------------------------------------------------------
        #region Registering
        public void Register(PersonalLogger box)
        {
            if (box == null)
                return;
        ...
        ///---------------------------------------------------------------------
        public void Unregister(PersonalLogger logger)
        {
            if (logger == null)
                return;
