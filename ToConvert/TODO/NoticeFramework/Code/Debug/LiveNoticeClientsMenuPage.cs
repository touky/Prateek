namespace Prateek.NoticeFramework.Debug
{
    using System;
    ...
    internal class LiveNoticeReceiversMenuPage : DebugMenuPage<NoticeDaemonCore>
    {
        #region Fields
        private ReflectedField<Dictionary<long, HashSet<NoticeReceiver>>> liveClients = "liveClients";
        ...
        #region Constructors
        public LiveNoticeReceiversMenuPage(NoticeDaemonCore owner, string title) : base(owner, title) { }
        #endregion
        ...
        protected INoticeReceiver GetNoticeReceiver(long key, int index)
        {
        ...
        {
            var validId = Notice.ConvertToId(type);
        ...
        protected override void Draw(NoticeDaemonCore owner, DebugMenuContext context)
        {
            for (var k = 0; k < KeyCount; k++)
            {
                var key        = this[k];
                var noticeName = noticeTypes.ContainsKey(key & Notice.ID_TYPE_MASK) ? noticeTypes[key & Notice.ID_TYPE_MASK].Name : "#UNDEFINED#"; //todo Consts.UNDEFINED;
