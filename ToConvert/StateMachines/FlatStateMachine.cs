namespace Assets.Prateek.ToConvert.StateMachines
{
    ...
    /// </summary>
    [Serializable]
    public class FlatStateMachine<TState, TTrigger> : SimpleStateMachine<TState, TTrigger>
        ...
        where TTrigger : struct, IConvertible
    {
        ...
        public FlatStateMachine(ISimpleStateMachineOwner<TState, TTrigger> owner, TState startState, string stateProfilerFormat = null, string triggerProfilerFormat = null)
