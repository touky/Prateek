...
namespace Mayfair.Core.Code.Localization
{
    ...
    public class LocalizationServiceProvider : ServiceProviderBehaviour
    {
        #region Classes
        ...
        public override bool IsProviderValid => true;
        ...
        {
            SendIdentificationFor<LocalizationService, LocalizationServiceProvider>(this);
        }
