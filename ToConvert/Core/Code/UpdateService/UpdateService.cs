namespace Mayfair.Core.Code.UpdateService
{
    ...
    /// </summary>
    public class UpdateService : ServiceCommunicatorBehaviour<UpdateService, UpdateProvider>
    {
        ...
        protected override void OnRegister(UpdateProvider provider)
        {
            ...
            GetFirstValidProvider().updateAction += OnUpdate;
        }
