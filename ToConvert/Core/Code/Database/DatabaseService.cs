namespace Mayfair.Core.Code.Database
{
    ...
    public sealed class DatabaseService : ResourceDependentService<DatabaseService, DatabaseServiceProvider>, IDebugMenuNotebookOwner
    {
        ...
        {
            DatabaseServiceProvider provider = GetFirstValidProvider();
            if (provider == null)
            {
                return;
            }

            provider.RefreshPendingResources(this);
        }
