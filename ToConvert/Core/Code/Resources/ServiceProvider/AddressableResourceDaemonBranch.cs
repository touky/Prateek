namespace Mayfair.Core.Code.Resources.ServiceProvider
{
    ...
    public class AddressableResourceDaemonBranch : ResourceDaemonBranch
    {
        #region Fields
        ...
        public override void ExecuteState(ResourceDaemonCore daemonCore, ServiceState state)
        {
            switch (state)
            {
                ...
                case ServiceState.InitWait:
                {
                    ...
                    {
                        daemonCore.Trigger(SequentialTriggerType.PreventStateChange);
                    }
                ...
                case ServiceState.ResourceTriage:
                {
                    ...
                    foreach (IResourceLocator locator in Addressables.ResourceLocators)
                    {
                        foreach (object key in locator.Keys)
                        {
                            ...
                            daemonCore.Store(new AddressableResourceLoader(location));
                        }
                    }
