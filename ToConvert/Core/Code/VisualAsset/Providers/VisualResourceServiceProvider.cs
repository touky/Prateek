namespace Mayfair.Core.Code.VisualAsset.Providers
{
    ...
    public abstract class VisualResourceServiceProvider : ResourceDependentServiceProvider<VisualResourceService, VisualResourceServiceProvider>, IDebugMenuNotebookOwner
    {
