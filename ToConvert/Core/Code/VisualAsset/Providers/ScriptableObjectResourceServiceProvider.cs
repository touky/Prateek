namespace Mayfair.Core.Code.VisualAsset.Providers
{
    ...
    public abstract class ScriptableObjectResourceServiceProvider<TScriptableResourceType> : VisualResourceServiceProvider<ScriptableObjectResourceReference<TScriptableResourceType>>
