namespace Mayfair.Core.Code.TimeService
{
    ...
    public class TimeService : ServiceSingletonBehaviour<TimeService, BaseTimeServiceProvider>, IDebugMenuNotebookOwner
    {
        ...
        protected override void OnRegister(BaseTimeServiceProvider provider)
        {
            base.OnRegister(provider);

            DateTime newReferenceTime = Providers[Providers.Count - 1].GetCurrentTime();
