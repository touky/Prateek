namespace Mayfair.Core.Editor.Utils
{
    ...
    public static class ProjectCleaning
    {
        ...
        [MenuItem("Tools/Project Cleaning/Clean project files and launch IDE")]
        ...
        [MenuItem("Tools/Project Cleaning/Remove Empty Directories", false, 800)]
        public static void CleanEmptyDirectories()
        {
            RemoveEmptyDirectories(ConstsFolders.ASSET + Path.DirectorySeparatorChar);
        }
