namespace Prateek.A_TODO.Runtime.AppContentUnityIntegration
{
    ...
    public class AssetReferenceScene : AssetReference
    {
        ...
        {
            AsyncOperationHandle<SceneInstance> result = UnityEngine.AddressableAssets.Addressables.LoadSceneAsync(RuntimeKey, loadMode);
        ...
        {
            AsyncOperationHandle<SceneInstance> result = UnityEngine.AddressableAssets.Addressables.UnloadSceneAsync(this.operation);
            this.operation = result;
            return result;
        }
