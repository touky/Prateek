namespace Mayfair.Core.Code.DebugMenu
{
    ...
    internal class DebugMenuStyle
    {
        ...
        //            string key = $"{typeof(DebugMenuDaemon).Name}.{typeof(DebugMenuContext).Name}";
        //            font =
        //#if UNITY_EDITOR
        ...
        //            float lineCount = Screen.height / lineHeight;
        //            int fontSize = Mathf.Max(1, Mathf.RoundToInt(Settings.fontSize * (lineCount / Settings.validLineCount)));
        //            if (Mathf.Abs(font.fontSize - fontSize) <= 2)
        //            {
        //                return;
        //            }

        //            for (int s = 0; s < proxies.Count; s++)
        //            {
        //                GUIStyleProxy proxy = proxies[s];
        ...
        //            for (int p = 0; p < progressBars.Length; p++)
        //            {
