namespace Mayfair.Core.Code.Utils.Debug
{
    ...
    public static partial class DebugTools
    {
        ...
        public static void Log(string notice, LogLevel logPriority = LogLevel.Normal)
        {
        ...
        public static void Log(string notice, Object context, LogLevel logPriority = LogLevel.Normal)
        {
            if (logLevel <= logPriority)
            {
                Debug.LogWarning(notice, context);
            }
        }

        public static void Log(string notice, params object[] args)
        {
            if (logLevel <= LogLevel.Normal)
            {
                notice = String.Format(notice, args);
                Log(notice);
            }
        }

        public static void Log(string notice, object[] args, LogLevel logPriority = LogLevel.Normal)
        {
            if (logLevel <= logPriority)
            {
                notice = String.Format(notice, args);
        ...
        public static void LogWarning(string notice, LogLevel logPriority = LogLevel.Normal)
        {
            if (logLevel <= logPriority)
            {
        ...
        public static void LogWarning(string notice, Object context, LogLevel logPriority = LogLevel.Normal)
        {
            if (logLevel <= logPriority)
            {
                Debug.LogWarning(notice, context);
        ...
        public static void LogWarning(string notice, params object[] args)
        {
            if (logLevel <= LogLevel.Normal)
            {
                notice = String.Format(notice, args);
        ...
        public static void LogWarning(string notice, object[] args, LogLevel logPriority = LogLevel.Normal)
        {
            if (logLevel <= logPriority)
            {
                notice = String.Format(notice, args);
        ...
        /// </summary>
        public static void LogError(string notice)
        {
        ...
        ///     Errors are always logged ot the console regardless of the logLevel
        /// </summary>
        public static void LogError(string notice, Object context)
        {
            Debug.LogError(notice, context);
        }

        /// <summary>
        ///     Errors are always logged ot the console regardless of the logLevel
        /// </summary>
        public static void LogError(string notice, params object[] args)
        {
            notice = String.Format(notice, args);
            LogError(notice);
        }
        ...
        public enum LogLevel
        {
            ...
            /// <summary>
            ///     <para>
            ///         The Low Priority option is for notices that are not verbose, but are also unnecessary in typical workflow.
            ///     </para>
            ///     <example>
